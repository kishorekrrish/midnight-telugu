...
- [ ] Blueprint ID is present for directed scripts
- [ ] If directed: narrative_score ≥ 90, quality_score ≥ 88, authenticity ≥ 90, continuity ≥ 90
- [ ] `hard_failures` is empty
- [ ] No protagonist drift, POV drift, missing clue payoff, or unplanned character/object/location appears in the review notes
