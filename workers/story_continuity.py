...
def _extract_character_names(text: str) -> list[str]:
    ...
    _STOP = {
        ...
        "చివరి", "రైలు", "ముసలాయన", "ఉన్న", "స్టేషన్", "ఫోటో",
        "ప్లాట్", "ఫామ్", "మాస్టర్", "సాక్ష్యం", "రిజిస్టర్",
        "మూడో", "అంతస్తు", "నర్స్", "ఫోన్", "నంబర్", "ఆసుపత్రి",
        "వాయిస్", "మెమో", "మందుల", "చార్ట్", "రికార్డు", "వృద్ధురాలి",
        "మీద", "నుంచి", "మాట",
        "రాలేదు", "వృద్ధురా", "చిన్న",
    }
...
def check_continuity(script: StoryScript | HumanizedScript) -> ContinuityResult:
    ...
    _CLUE_WORDS = [
        ...
        "వాయిస్ మెమో", "మందుల చార్ట్", "మందుల ట్రే", "ఫోటో",
    ]
