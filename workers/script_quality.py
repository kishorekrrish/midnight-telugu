...
_SENSORY_SIGNALS = [
    ...
    "మెరిసింది", "చల్లగా", "వేడిగా", "తడిగా", "ఫోన్", "మందుల", "నర్స్ స్టేషన్",
]
...
_ESCALATION_SIGNALS = [
    ...
    "కానీ,", "అయితే", "హృదయం గట్టిగా", "గుండె పిండి",
    "రిజిస్టర్", "స్టేషన్ మాస్టర్", "సందేహం", "వాయిస్ మెమో",
    "మందుల చార్ట్", "ప్లే చేసింది", "ట్రే పెట్టింది", "ఫోన్ ఆగిపోయింది",
]
...
_TWIST_SIGNALS = [
    ...
    "చనిపోయాడు", "చనిపోయారు", "చివరి సాక్ష్యం", "నిర్ధారించే",
    "ఐదు సంవత్సరాల క్రితం", "అదే స్టేషన్‌లో", "ఈరోజైనా", "సమయానికి",
    "ఫోన్ రాలేదు", "వాయిస్ మెమో", "అమ్మా",
]
...
def validate_script(script: StoryScript | HumanizedScript) -> ScriptQualityResult:
    ...
    _CINEMATIC_CLOSING_SIGNALS = [
        ...
        "ఈరోజైనా", "సమయానికి ఇచ్చావు", "ఫోన్ రాలేదు",
    ]
